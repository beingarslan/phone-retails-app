...
<section id="gradient-buttons">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <button type="button" class="btn btn-gradient-primary" data-bs-toggle="modal" data-bs-target="#addAdvertisingModel">Add Supplier</button>
                    <!-- Add User Model -->
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
                            <div class="modal-content">
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    ...
                                    <form id="editUserForm" class="row gy-1 pt-75" action="{{route('admin.suppliers.save')}}" method="POST">
                                        @csrf
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="country" placeholder="Country">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="name">Contact Person Name</label>
                                                <input type="text" class="form-control" id="name" name="contact_person_name" placeholder="Contact Person Name">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="name">Contact Person Phone</label>
                                                <input type="text" class="form-control" id="name" name="contact_person_phone" placeholder="Contact Person Phone">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="name">Contact Person Email</label>
                                                <input type="text" class="form-control" id="name" name="contact_person_email" placeholder="Contact Person Email">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
...
<script>
    $(function() {
        $('#users-table').DataTable({
            ...
            ajax: '{!! route("admin.suppliers.suppliers") !!}',
            columns: [
